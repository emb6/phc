      ...
      <section className="px-5 md:py-10 lg:16 bg-secondary-gray">
        <div className="max-w-7xl mx-auto px-4 py-5 lg:px-10 lg:py-16">
          <Slider {...settings} className="lg:pb-16 ">
            <div className="!inline-flex items-center h-full justify-center gap-10">
              <div className="!z-5 relative flex rounded-[20px] max-w-[300px] bg-clip-border shadow-3xl shadow-shadow-500  flex-col w-full !p-4 3xl:p-![18px] bg-white ">
